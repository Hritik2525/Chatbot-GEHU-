...
class ChatApplication:
    ...
    def _setup_main_window(self):
        ...
        # head label
        head_label = Label(self.window, bg=BG_COLOR, fg="#111111", text="G.E.H.U. Chatbot", font="HelvLight 22 bold underline", pady=10)
        ...
        # text widget
        self.text_widget = Text(self.window, width=20, height=2, bg="#01236A", fg=TEXT_COLOR, font=FONT, padx=5, pady=5)
